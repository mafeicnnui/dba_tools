...
cfg = {
    ...
    "schema": "hft_hopson_hft",
     ...
     "sql":"""select io.business_name    AS businessName,
            ...
            where  io.business_id = '{}'
              ...
              and io.create_time between '2022-01-01' and '2022-01-31'
    ...
    "sql_hz":"""SELECT
            ...
            FROM `intel_order2` o
             WHERE o.`create_time`  >=  '2022-01-01' AND o.`create_time`  <=  '2022-12-31'            
                AND o.market_id = 218
...
def get_thream_num():
    ...
    st = """SELECT business_id,
                   terminal_no
            FROM `intel_order2` 
            WHERE create_time >='2022-01-01' and payment_time <='2022-01-31' AND status=3 
    ...
    try:
        ...
        while True:
            try:
                ...
                i += 1
                print('db is error,recconnected!(times={}'.format(str(i)))
                continue
