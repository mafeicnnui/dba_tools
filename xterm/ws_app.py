...
# -*- encoding:utf-8 -*-
# author: zhiminliu
# https://blog.csdn.net/m0_37845900/article/details/122705919
...
class LoginHandler(BaseHandler):
    ...
    def post(self):
        ...
        try:
            ...
            print("LoginHandler:登录失败")
            respon_json = {"status": False, "response": str(traceback.print_exc())}
            print(traceback.print_exc())
...
class WebSocketHandler(tornado.websocket.WebSocketHandler):
    ...
    def open(self):
        ...
        print(host, int(port), username, passwd)
    ...
    def on_message(self, message):
        try:
            ...
            print('on_message:',traceback.print_exc())
...
class Application(tornado.web.Application):
    def __init__(self):
        ...
        settings = {"template_path": ".", "static_path": "static",
                    "cookie_secret": "bZJc2sWbQLKos6GkHn/VB9oXwQt8S0R0kRvJ5/xJ89E=", "login_url": "/"}
