...
'''
config = {
    "chat_interface":"https://alarm.lifeat.cn/wx/cp/msg/1000016",
...
'''
    ...
    v_content = ft.format(
        ...
        r['total_num'],
        r['num'],
        str(round(r['num'] / r['total_num'], 4) * 100) [0:5]+ '%',
        r['tatal2'],
        str(round(r['tatal2']/r['total_num'],4)*100)[0:5]+'%',
        config['warn_level'],
        get_time()
    )
    send_message(v_title + v_content)
