...
def get_mongo_where(cfg):
    v_rqq = parser.parse('2020-04-06T00:00:00.000Z')
    v_rqz = parser.parse('2020-04-07T23:59:59.000Z')
    v_json = {"$and":[
...
if __name__ == "__main__":
    ...
    get_images(config,shopMap_218)

    # #生成上海店铺小票html
    # config['marketId'] ='shhsh'
    # get_images(config,shopMap_110)
