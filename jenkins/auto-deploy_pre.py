...
class Jenkins_task:
    def __init__(self,jenkins_url,user,password):
        ...
        self.user     =  user          #登陆jenkins网页端用户名
        self.password = password #'hopson@2019'      #登陆jenkins网页端秘密
    ...
    def build_job(self):    #构建任务
        try:
            param_dict = {'Branch': 'release-4.0.4.1'}
...
job_list = ['hopsonone-coupons-api','hopsonone-coupons-cms','hopsonone-coupons-dcs','hopsonone-coupons-push','hopsonone-coupons-search','hopsonone-coupons-service','mall-order-service','one-flash-sale-api','one-flash-sale-data-service','one-flash-sale-dcs','one-member-marketing-cms','hopsonone-card-api','hopsonone-card-cms','one-business-api','one-business-cms','one-business-dcs','one-park-api','one-park-cms','park-carinout','park-booking','one-cms-dcs','one-base-api','one-personal-api','one-activity-api','one-homepage-api','one-notify-service','one-points-api','one-cms','one-push-api','one-order-center-service','one-market-analysis','one-activity-cms','one-activity-job','one-games-cms','mall-goods-service','mall-goods-dcs','one-mvms-service','one-mvms-cms-service','one-mvms-dcs']


jenkins_url  = 'http://39.107.236.63:28080'
jenkins_user = 'admin'  # 登陆jenkins网页端用户名
jenkins_password = '11186475b60ffff8e50a1672c936a5fca7'  # 'hopson@2019'      #登陆jenkins网页端秘密
