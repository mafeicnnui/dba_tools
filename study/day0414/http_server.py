...
from   study.day0414.db_user import save_user,query_user,get_genders
from   study.day0414.utils import get_host_ip

# 控制器
class user(tornado.web.RequestHandler):
     def get(self):
        self.render('add_user.html',genders=get_genders())
